...
#  although all this class does is accept the call and echo back the supplied value.
#
##################################################################################################
...
class Passthru
    """
        Just provide the basic Author transformation API elements to be able to echo back
        a supplied value.
    """
    ...
    def echoSuppliedValue(committer)
        """
    ...
    def service(target)
        return echoSuppliedValue(target)
    end
